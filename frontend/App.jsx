...
import { registerServiceWorker, setupOfflineDetection } from './utils/serviceWorker'
    ...
    <div className="max-w-7xl mx-auto flex items-center justify-between">
      <div className="flex items-center space-x-3">
        ...
        <div>
          ...
          <p className="text-xs opacity-90">Click update to get the latest features and improvements.</p>
        </div>
      </div>
