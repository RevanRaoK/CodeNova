  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        ...
        // Fetch feedback data
        const feedbackData = await feedbackService.getFeedbackStatistics({
          timeframe,
        });
          ...
          recentActivity: [
            {
              id: 1,
              type: 'review',
              description: 'Code review completed for feature/auth-system',
              time: '2 minutes ago',
              status: 'success',
            },
            {
              id: 2,
              type: 'feedback',
              description: 'Positive feedback received on security suggestions',
              time: '15 minutes ago',
              status: 'positive',
            },
            {
              id: 3,
              type: 'pattern',
              description: 'New pattern detected in React components',
              time: '1 hour ago',
              status: 'info',
            },
            {
              id: 4,
              type: 'review',
              description: 'Code review completed for bugfix/login-validation',
              time: '2 hours ago',
              status: 'success',
            },
            {
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {stats.map((stat) => (
          <div
            key={stat.name}
            className="bg-white rounded-lg shadow p-6 transition-colors duration-200"
          >
